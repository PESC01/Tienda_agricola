                            ...
                            <div className='pr-2 md:pr-0'>
                                ...
                                }
                                {
                                    paymentMethod === 'bkash' && <div className='w-full px-4 py-8 bg-white shadow-sm'>
                                        <button className='px-10 py-[6px] rounded-sm hover:shadow-wrange-500/20 hover:shadow-lg bg-orange-500 text-white'>Pedir ahora</button>
                                    </div>
                                }
                                {
                            ...
                            <div className='pl-2 md:pl-0 md:mb-0'>
                                <div className='bg-white shadow p-5 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <div className='flex justify-between items-center font-semibold'>
                                        ...
                                        <span className='text-lg text-orange-500'>Bs{price}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
