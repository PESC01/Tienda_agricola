                    ...
                    <div className='grid grid-cols-2 md-lg:grid-cols-1 gap-8'>
                        ...
                        <div className='flex flex-col gap-5'>
                            ...
                            <div className='text-2xl text-red-500 font-bold flex gap-3'>
                                {
                                    product.discount !== 0 ? <>
                                        <h2 className='line-through'>Bs{product.price}</h2>
                                        <h2>Bs{product.price - Math.floor((product.price * product.discount) / 100)} (-{product.discount}%)</h2>
                                    </> : <h2>Precio : Bs{product.price}</h2>
                                }
                            </div>
                            ...
                            <div className='flex gap-3 pb-10 border-b'>
                                {
                                    product.stock ? <>
                                        ...
                                        <div>
                                            <button onClick={add_card} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-purple-500/40 bg-purple-500 text-white'>Añadir a la tarjeta</button>
                                        </div>
                                    </> : ''
                                }
                                <div>
                            ...
                            <div className='flex gap-3'>
                                ...
                                <Link to={`/dashboard/chat/${product.sellerId}`} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-lime-500/40 bg-lime-500 text-white block'>Chat Vendedor</Link>
                            </div>
                        </div>
                    </div>
                </div>
