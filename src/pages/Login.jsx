                    ...
                    <div className='grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md'>
                        <div className='px-8 py-8'>
                            ...
                            <div className='text-center text-slate-600 pt-1'>
                                <p>No tienes una cuenta ? <Link className='text-blue-500' to='/register'>Registrate</Link></p>
                            </div>
                            <div className='text-center text-slate-600 pt-1'>
                                <p> <a target='_black' className='text-blue-500' href='http://localhost:3001/register'>Registrate</a> como vendedor</p>
                            </div>
                        </div>
                        <div className='w-full h-full py-4 pr-4'>
                            <img className='w-full h-[95%]' src="/images/imgforlog.webp" alt="" />
                        </div>
                    </div>
                </div>
            </div>
