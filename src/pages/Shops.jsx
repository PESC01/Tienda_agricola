...
const Shops = () => {
    ...
    return (
        <div>
            <Headers />
            <section className='bg-[url("http://localhost:3000/images/banner/agricola.gif")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            ...
            <section className='py-16'>
                <div className='w-[85%] md:w-[90%%] sm:w-[90%] lg:w-[90%] h-full mx-auto'>
                    <div className={`md:block hidden ${!filter ? 'mb-6' : 'mb-0'}`}>
                        <button onClick={() => setFilter(!filter)} className='text-center w-full py-2 px-3 bg-indigo-500 text-white'>Filtrar producto</button>
                    </div>
                    <div className='w-full flex flex-wrap'>
                        <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0'}`}>
                            <h2 className='text-3xl font-bold mb-3 text-slate-600'>Categorías</h2>
                            <div className='py-2'>
                                {
                            ...
                            <div className='py-2 flex flex-col gap-5'>
                                ...
                                />
                                <div>
                                    <span className='text-red-500 font-bold text-lg'>Bs {Math.floor(state.values[0])} - Bs {Math.floor(state.values[1])}</span>
                                </div>
                            </div>
                            <div className='py-3 flex flex-col gap-4'>
                                <h2 className='text-3xl font-bold mb-3 text-slate-600'>Calificación</h2>
