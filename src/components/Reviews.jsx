    ...
    <div className='mt-8'>
      <div className='flex gap-10 md:flex-col'>
        <div className='flex flex-col gap-2 justify-start items-start py-4'>
          ...
          <p className='text-sm text-slate-600'>{totalReview} Reseñas</p>
        </div>
      ...
      <div>
        {
          userInfo ? <div className='flex flex-col gap-3'>
            ...
            <form onSubmit={review_submit}>
              ...
              <div className='mt-2'>
                <button className='py-1 px-5 bg-indigo-500 text-white rounded-sm'>Entregar</button>
              </div>
            </form>
          </div> : <div>
            <Link className='py-1 px-5 bg-indigo-500 text-white rounded-sm' to='/login'>Acceso</Link>
          </div>
        }
      </div>
    </div>
