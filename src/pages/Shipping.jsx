                        ...
                        <div className='w-[67%] md-lg:w-full'>
                            <div className="flex flex-col gap-3">
                                <div className="bg-white p-6 shadow-sm rounded-md">
                                    {
                                        !res && <>
                                            <h2 className='text-slate-600 font-bold pb-3'>Información de Envío</h2>
                                            <form onSubmit={save}>
                                                ...
                                                <div className='flex md:flex-col md:gap-2 w-full gap-5 text-slate-600'>
                                                    ...
                                                    <div className='flex flex-col gap-1 mb-2 w-full'>
                                                        <label htmlFor="post">Código Postal</label>
                                    ...
                                    }
                                    {
                                        res && <div className='flex flex-col gap-1'>
                                            ...
                                            <p>
                                                <span className='bg-blue-200 text-blue-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded'>Casa</span>
                                                <span className='text-slate-600 text-sm'>{state.address} {state.province} {state.city} {state.area}</span>
                                                <span onClick={() => setRes(false)} className='text-indigo-500 cursor-pointer'> Guardar</span>
                                            </p>
                                            <p className='text-slate-600 text-sm'>Correo a segoviacondoripabloerwin@gmail.com</p>
                                        </div>
                                    }
                                </div>
                                {
                                            ...
                                            p.products.map((pt, j) => <div key={i + 99} className='w-full flex flex-wrap'>
                                                ...
                                                <div className='flex justify-end w-5/12 sm:w-full sm:mt-3'>
                                                    <div className='pl-4 sm:pl-0'>
                                                        ...
                                                        <p className='line-through'>Bs{pt.productInfo.price}</p>
                            ...
                            <div className="pl-3 md-lg:pl-0">
                                <div className='bg-white font-medium p-5 text-slate-600 flex flex-col gap-3'>
                                    ...
                                    <div className='flex justify-between items-center'>
                                        <span>Total de Items({price})</span>
                                        <span>Bs{price}</span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                    ...
                                    <div className='flex justify-between items-center'>
                                        ...
                                        <span>Bs{price + shipping_fee}</span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                        <span>Total</span>
                                        <span>Bs{price + shipping_fee}</span>
